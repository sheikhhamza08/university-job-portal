            ...
            >
              ...
              >
                ...
                <p className="text-white/90 text-sm">
                  Sign in to access your Dublin Business School job portal
                </p>
              </motion.div>
            </div>
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="pl-10 py-5 transition-all duration-200 rounded-xl"
                    style={{
                      borderColor: colors.lightBlue,
                      focus: { borderColor: colors.brightBlue },
                    }}
                    required
                  />
                </div>
